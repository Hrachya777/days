	...
	<div class="col-md-6">
		...
		<span class="col-md-12" style="margin-top:12px">
			<label class="pull-right inline">
				...
				<input id="id-button-borders"  type="checkbox" class="ace ace-switch ace-switch-5 youtube_autoplay">
				<span class="lbl middle"></span>
			</label>
		</span>
		<span class="col-md-12" style="margin-top:12px">
			<label class="pull-right inline">
				...
				<input id="id-button-borders" type="checkbox" class="ace ace-switch ace-switch-5 show_info">
				<span class="lbl middle"></span>
			</label>
		</span>
		<span class="col-md-12" style="margin-top:12px">
			<label class="pull-right inline">
				...
				<input id="id-button-borders" type="checkbox" class="ace ace-switch ace-switch-5 show_panel">
				<span class="lbl middle"></span>
			</label>
		</span>
		<span class="col-md-12" style="margin-top:12px">
